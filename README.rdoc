...
== Configuration
    ...
    <match pattern>
      ...
      auth_url https://your.swift.proxy/auth/v1.0 or https://your.keystone/v2.0
...
[auth_url] Authentication URL. ex. if you use TempAuth, https://your.swift.proxy/auth/v1.0 . Keystone Auth isn't tested yet.
